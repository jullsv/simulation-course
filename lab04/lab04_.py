...
def main():
    ...
    print()
    print(f"Среднее: {mean:.6f} (отклонение = {diff_mean:+.6e})")
    print(f"Дисперсия: {var:.6f} (отклонение = {diff_var:+.6e})")

    print()

    print("Встроенный датчик")
    print()
    print(f"Среднее: {mean_:.6f} (отклонение = {diff_mean_:+.6e})")
    print(f"Дисперсия: {var_:.6f} (отклонение = {diff_var_:+.6e})")
